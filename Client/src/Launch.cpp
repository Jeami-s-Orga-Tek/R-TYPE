...
void Launch::draw(sf::RenderWindow& window)
{
    window.draw(logoSprite);
}

void Launch::handleEvent(const sf::Event& event, sf::RenderWindow& window)
{
